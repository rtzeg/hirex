...
const MainSection = ({ videoUrl = localVideo }) => {
  ...
  return (
    <section className="main-section relative overflow-hidden m-0 p-0 bg-transparent -mt-[102px] max-[1200px]:-mt-[86px]">
      <div className="relative mx-auto w-[100%] max-w-[1920px] pt-[40px] max-[1200px]:pt-[40px]">
        <div className="main-section__wrap relative">
          ...
          <div className="main-section__card relative overflow-hidden rounded-none shadow-[0_25px_120px_rgba(0,0,0,0.55)]">
